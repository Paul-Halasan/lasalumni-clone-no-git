...
import classes from "../../user_alumni/alumni-profile/profile.module.css";
...
function UserProfile() {
  ...
  // Move this after loading/error checks if you want to use the latest profile data
...
export default withAuth(UserProfile, ["partner"]);
