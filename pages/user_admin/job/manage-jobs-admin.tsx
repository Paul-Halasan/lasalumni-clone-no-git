...
const PartnerCompanyJobsAdmin: React.FC = () => {
  ...
  const fetchJobs = async () => {
    ...
    try {
      const response = await axios.post(
        "/api/admin_get_all_jobs", // Admin-specific API endpoint to fetch all jobs
        {
...
export default withAuth(PartnerCompanyJobsAdmin, "admin");
